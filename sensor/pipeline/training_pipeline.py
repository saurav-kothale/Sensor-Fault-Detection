...
class TrainingPipeline: 
    ...
    def start_model_evaluation(
        ...
        try:
            ...
            model_eval = ModelEvaluation(model_eval_config,model_trainer_artifact, data_validation_artifact)
    ...
    def run_pipeline(self):
        try:
            TrainingPipeline.is_running = True
            ...
            TrainingPipeline.is_running = False
